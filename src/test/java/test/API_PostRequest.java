...
public class API_PostRequest {
    ...
    public void post01(){
        ...
        /*
           https://jsonplaceholder.typicode.com/posts url'ine asagıdaki
            body ile bir POST request yolladğımızda
        ...
        // 2 - Expected Data olustur (beklenen data)
        ...
        JsonPath actBody = response.jsonPath(); //response ı kaydediyoruz.
